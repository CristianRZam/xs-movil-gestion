...
class InventoryMovementRepositoryImpl implements InventoryMovementRepository {
  ...
  @override
  Future<Either<Failure, List<InventoryMovementDetail>>>
  getInventoryMovements(int productId,) async {
    try {
      final response = await remoteDataSource.getInventoryMovements(productId,);
  ...
  @override
  Future<Either<Failure, InventoryMovement>>
  createInventoryMovement(InventoryMovementCreateRequest request,) async {
    try {
      final response = await remoteDataSource.createInventoryMovement(InventoryMovementCreateRequestModel.fromEntity(
          request,
        ),
      );
