...
class GetNotificationsUseCase {
  ...
  ]) => _repository.getNotifications(filter);
}
...
class GetNotificationVisibleDaysUseCase {
  const GetNotificationVisibleDaysUseCase(this._repository);
  final NotificationRepository _repository;
  Future<Either<Failure, int>> call() => _repository.getVisibleDays();
}
