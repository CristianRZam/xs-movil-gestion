...
class OrderRepositoryImpl implements OrderRepository {
  ...
  @override
  Future<Either<Failure, List<Order>>> getAll() => _handle(() => remoteDataSource.getAll());
  @override
  Future<Either<Failure, Order>> create(Order order) => _handle(() => remoteDataSource.create(OrderModel.fromEntity(order)));
  @override
  Future<Either<Failure, Order>> update(int id, Order order) => _handle(() => remoteDataSource.update(id, OrderModel.fromEntity(order)));
  @override
  Future<Either<Failure, Order>> updateStatus(int id, String status) => _handle(() => remoteDataSource.updateStatus(id, status));
  @override
  Future<Either<Failure, bool>> delete(int id) => _handle(() => remoteDataSource.delete(id));
